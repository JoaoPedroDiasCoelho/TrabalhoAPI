...
public class OpenApiConfig {
    ...
    // Injetando as URLs dos ambientes. Usamos valores padrão caso a propriedade falhe.
    // Isso resolve o erro 'Injection of autowired dependencies failed' que você teve.
    ...
    private String prodUri; // Renomeado para maior clareza

    @Bean
    public OpenAPI openApiConfig() {
        
        // 1. Definição dos Servidores (URLs)
        ...
        return new OpenAPI()
                .info(info)
                // Adiciona os servidores à configuração do Swagger
